    ...
    <>
      ...
      <div className="cookie-banner" id="cookie-banner" role="region" aria-label="Aviso de cookies" style={{ display: "none" }}>
        <p className="cookie-text">
          ...
          <a href={`${process.env.NEXT_PUBLIC_BASE_PATH ?? ""}/politica-privacidad/`} className="cookie-link">Más información</a>
        </p>
        ...
        <div className="container">
          <div className="footer-inner">
            ...
            <ul className="footer-links" role="list">
              ...
              <li><a href={`${process.env.NEXT_PUBLIC_BASE_PATH ?? ""}/politica-privacidad/`}>Aviso Legal & Privacidad</a></li>
            </ul>
